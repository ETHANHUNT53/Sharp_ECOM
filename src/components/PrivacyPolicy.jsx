...
const PrivacyPolicy = () => {
  return (
    <div className="w-[60%] mx-auto">
      <h2 className="my-[5%] text-4xl font-bold">Privacy Policy</h2>
      <div className="my-[4%]  text-justify">
        <h4 className="mb-[2%] text-2xl font-semibold">Introduction</h4>
        <p>
          This Privacy Policy describes how SHARP INDUSTRIES and its affiliates
          (collectively “SHARP INDUSTRIES, we, our, us”) collect, use, share,
      ...
      <div className="my-[4%]  text-justify">
        <h4 className="mb-[2%] text-2xl font-semibold">Collection</h4>
        <p>
          ...
          SHARP INDUSTRIES seeking any personal data like debit/credit card PIN,
      ...
      <div className="my-[4%]  text-justify">
        <h4 className="mb-[2%] text-2xl font-semibold">Usage</h4>
        <p>
          {" "}
      ...
      <div className="my-[4%]  text-justify">
        <h4 className="mb-[2%] text-2xl font-semibold">Sharing</h4>
        <p>
      ...
      <div className="my-[4%]  text-justify">
        <h4 className="mb-[2%] text-2xl font-semibold">Security Precautions</h4>
        <p>
      ...
      <div className="my-[4%]  text-justify">
        <h4 className="mb-[2%] text-2xl font-semibold">Your Rights</h4>
        <p>
      ...
      <div className="my-[4%]  text-justify">
        <h4 className="mb-[2%] text-2xl font-semibold">Consent</h4>
        <p>
