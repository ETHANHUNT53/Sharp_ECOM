...
const TermsAndConditionsPolicy = () => {
  return (
    <div className="w-[60%] mx-auto">
      <h2 className="my-[5%] text-4xl font-bold">Terms & Conditions</h2>
      <div className="my-[4%]  text-justify">
        <p>
          ...
          intellectual property rights) of a third party. Notwithstanding
          anything contained in these Terms of Use, the parties shall not be
          liable for any failure to perform an obligation under these Terms if
          ...
          India.. All concerns or communications relating to these Terms must be
