  ...
  return (
    <>
      ...
      <section className=" relative  after:contents-[''] after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0 after:bg-gray-50 ">
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto relative z-5">
          <div className="grid grid-cols-12">
            <div className="col-span-12 xl:col-span-8 lg:pr-8 pt-14 pb-8 lg:py-24 w-full max-xl:max-w-3xl max-xl:mx-auto">
              <div className="flex items-center justify-between pb-8 border-b border-gray-300 mt-16">
              ...
              {items.length == 0 ? (
                <div className="flex-col my-[25%] mx-[20%] h-full">
                  <h2 className="font-manrope font-semibold sm:text-5xl md:text-3xl  leading-10 text-black mb-8">
                    {" "}
                    Your Cart is empty!
                  </h2>
                  ...
                  <div>
                    <button
                      className="rounded-lg sm:w-[35%] bg-blue-800 py-2.5 px-4 text-white text-sm font-semibold text-center mb-8 transition-all duration-500 hover:bg-blue-900 cursor-pointer sm:ml-25 md:ml-[5%]"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 w-full">
                    ...
                    <div className="flex items-center max-[500px]:justify-center h-full max-md:mt-3">
                      <div className="flex items-center h-full">
                        <button
                          className="group rounded-l-xl px-5 py-[18px] border cursor-pointer border-gray-200 flex items-center justify-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-gray-50 hover:border-gray-300 hover:shadow-gray-300 focus-within:outline-gray-300"
                    ...
                    <div className="flex items-center max-[500px]:justify-center  max-md:mt-3 h-full ">
                      <button
                        className="p-1 px-2 bg-black text-white rounded-md cursor-pointer hover:bg-gray-800"
            ...
            {items.length !== 0 && (
              <div className=" col-span-12 xl:col-span-4 bg-gray-50 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto lg:pl-8 py-24 md:mt-16">
                ...
                <div className="flex pb-4 w-full">
                  <div className="relative w-full ">
                    ...
                    <div
                      id="dropdown"
                      className="absolute top-10 right-0 z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 "
                    ></div>
                  </div>
                </div>
